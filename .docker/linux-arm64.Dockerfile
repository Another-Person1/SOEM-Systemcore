...
# Prepare dockcross for use in Jenkins
ARG BUILDER_UID=1001
ARG BUILDER_GID=1001
ARG BUILDER_USER=rtljenkins
ARG BUILDER_GROUP=rtljenkins
RUN BUILDER_UID=${BUILDER_UID} BUILDER_GID=${BUILDER_GID} BUILDER_USER=${BUILDER_USER} BUILDER_GROUP=${BUILDER_GROUP} /dockcross/entrypoint.sh echo "Setup jenkins user"
